var characters = {
  ...
  $(document).ready(function() {
    ...
    $("#wyatt").on("click", function () {
        ...
        console.log("John Ruth is selected");
        ...
        initializeCharacter(characters.john);
        ...
        $("#john").removeClass("available-character").addClass("chosen-character");
        ...
        if($("#john").hasClass("enemy-character")) {
        ...
        initializeDefender(characters.john);
        ...
        $("#john").removeClass("enemy-character").addClass("defender-character");
